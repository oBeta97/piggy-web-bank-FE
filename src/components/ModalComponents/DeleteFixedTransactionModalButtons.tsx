...
import { deleteFixedTransaction } from "../../modules/fetches/FixedTransactions";



const DeleteFixedTransactionModalButtons = () => {
    ...
    const handleDeleteClick = async ():Promise<void> => {
        ...
        const deleteRes = await deleteFixedTransaction(selectedDynamicTableRow.rowElementId as number)
...
export default DeleteFixedTransactionModalButtons;